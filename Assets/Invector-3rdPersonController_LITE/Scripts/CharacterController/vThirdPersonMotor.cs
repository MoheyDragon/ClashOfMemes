...
namespace Invector.vCharacterController
{
    ...
    {
        public void UpdateSpeed(float newWalkSpeed)
        {
            // Update walkSpeed
            freeSpeed.walkSpeed = newWalkSpeed;
            strafeSpeed.walkSpeed = newWalkSpeed;

            // Update runningSpeed and sprintSpeed based on walkSpeed
            freeSpeed.runningSpeed = newWalkSpeed * 2f;
            strafeSpeed.runningSpeed = newWalkSpeed * 2f;

            freeSpeed.sprintSpeed = newWalkSpeed * 3f;
            strafeSpeed.sprintSpeed = newWalkSpeed * 3f;

            // Update airSpeed to be the same as sprinting speed
            airSpeed = newWalkSpeed * 3f;
        }
